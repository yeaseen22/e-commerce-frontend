                        ...
                        <div className="special-product-content">
                            ...
                            <div className="prod-count my-3">
                                ...
                                <div className="progress">
                                    <div className="progress-bar" role="progressbar" style={quantity / quantity + sold * 100 + "%"} aria-valuenow={quantity / quantity + sold * 100} aria-valuemin={quantity} aria-valuemax={sold + quantity}></div>
                                </div>
                            </div>
